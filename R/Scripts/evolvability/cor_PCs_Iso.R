...
atuais = data.frame(names(vcv), cor_iso_1, cor_iso_2, cor_iso_3, cor_iso_4, cor_iso_5, cor_iso_6, cor_iso_7, cor_iso_8)
atuais = atuais[complete.cases(atuais), ]
